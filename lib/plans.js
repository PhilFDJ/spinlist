...
module.exports = {
  ...
  trial: {
    ...
    branding: true,
    spotifyExport: true,
    weddingPlanner: true,         // trials can try the planner
    features: [
      '2 free events',
  ...
  studio: {
    ...
    branding: true,
    spotifyExport: true,
    weddingPlanner: false,       // planner now lives in the PRO WEDDING tier only
    features: [
      'Unlimited events',
      'Unlimited guests',
      'Everything in BASIC',
      'Export your setlist to CSV',
  ...
  // Top tier: everything in PRO, plus the Wedding Planner.
  // internal id 'prowedding'; Stripe price in STRIPE_PRICE_PROWEDDING.
  prowedding: {
    id: 'prowedding',
    name: 'PRO WEDDING',
    priceLabel: '£25 / mo',
    blurb: 'Everything in PRO, plus the full Wedding Planner.',
    maxEventsPerMonth: null,     // unlimited
    maxGuestsPerEvent: null,     // unlimited
    branding: true,
    spotifyExport: true,
    weddingPlanner: true,        // the only tier with the planner
    features: [
      'Everything in PRO',
      'Wedding Planner — song blocks, timeline & questionnaire',
      'Couples log in to fill their song choices',
      'Live guest requests on the night',
      'PDF run-sheet & CSV exports',
    ],
    stripePriceEnv: 'STRIPE_PRICE_PROWEDDING',
    purchasable: true,
    popular: true,
  },
  // Multi-operator: everything in PRO WEDDING, plus sub-DJ accounts.
  proweddingmulti: {
    id: 'proweddingmulti',
    name: 'PRO WEDDING MULTI-OP',
    priceLabel: '£35 / mo',
    blurb: 'For agencies: everything in PRO WEDDING, plus your own team of DJs.',
    maxEventsPerMonth: null,
    maxGuestsPerEvent: null,
    branding: true,
    spotifyExport: true,
    weddingPlanner: true,
    multiOp: true,               // can create & manage sub-DJ accounts
    features: [
      'Everything in PRO WEDDING',
      'Create sub-DJ accounts for your team',
      'Assign events & weddings to each DJ',
      'DJs see only their assigned jobs',
      'Each DJ gets their own profile',
    ],
    stripePriceEnv: 'STRIPE_PRICE_PROWEDDINGMULTI',
    purchasable: true,
  },
};
